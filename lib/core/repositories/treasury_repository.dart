...
final treasuryRepositoryProvider = Provider<TreasuryRepository>((ref) {
  return TreasuryRepository(FirebaseFirestore.instance);
});

class TreasuryRepository {
  final FirebaseFirestore _db;

  TreasuryRepository(this._db);
